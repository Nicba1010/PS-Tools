...
from utils.utils import read_u32, Endianess, read_u8, unpack_u32, read_u64
from .application_type import ApplicationType
from .errors import InvalidEDATBlockSizeException
...
class EDATHeader(MagicFileHeader):
